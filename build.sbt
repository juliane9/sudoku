...
lazy val sudokuJS = project in file("./apps/project")
lazy val sudokuJVM = project in file("./apps/project")
...
lazy val driverJS = driver.js.dependsOn(sudokuJS)
lazy val driverJVM = driver.jvm.dependsOn(sudokuJVM)

/// Aggregate project

lazy val webapp = (project in file("."))
  .aggregate(
    sudokuJS, sudokuJVM, driverJS, driverJVM
  ).settings(
    name := "webapp",
    scalaVersion := "3.3.1",
    scalacOptions ++= Seq("-deprecation"),
